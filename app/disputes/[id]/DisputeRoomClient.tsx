...
export default function DisputeRoomClient({
  ...
  // Initial dispute + messages come from the server (source of truth). This
  // effect only wires the realtime subscription for incoming messages.
  useEffect(() => {
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          // Reload (to get sender names) only for messages from the other party;
          // we add our own optimistically in handleSendMessage.
