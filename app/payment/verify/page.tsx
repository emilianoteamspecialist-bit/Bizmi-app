          ...
          <CardContent className="p-8">
            {status === "loading" && (
              <div className="space-y-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">Please wait while we verify your wallet funding...</p>
              </div>
            )}
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-400">Amount Funded:</span>
                    ...
                    <div className="flex justify-between border-t border-green-200 dark:border-green-700 pt-2">
                      <span className="text-gray-600 dark:text-gray-400">New Wallet Balance:</span>
                      <span className="font-medium text-green-700 dark:text-green-300">
