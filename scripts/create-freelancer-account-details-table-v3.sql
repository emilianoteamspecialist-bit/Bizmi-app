...
DROP POLICY IF EXISTS "Freelancers can view own account details" ON public.Freelancer_account_details;
DROP POLICY IF EXISTS "Freelancers can insert own account details" ON public.Freelancer_account_details;
DROP POLICY IF EXISTS "Freelancers can update own account details" ON public.Freelancer_account_details;
DROP POLICY IF EXISTS "Freelancers can delete own account details" ON public.Freelancer_account_details;
